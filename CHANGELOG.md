...
- [Update release.yml with permissions for OIDC](https://github.com/ionide/FSharp.Analyzers.SDK/pull/303) (thanks @baronfel!)

## [0.37.1] - 2026-06-17

### Changed

- [Add NuGet login step for package publishing](https://github.com/ionide/FSharp.Analyzers.SDK/pull/301) (thanks @baronfel!)

## [0.37.0] - 2026-06-04

### Changed

- [Updated FSharp.Core to 10.1 and FSC to 43.12](https://github.com/ionide/FSharp.Analyzers.SDK/pull/300) (thanks @Thorium!)

## [0.36.0] - 2026-02-02

### Added

- [Add overridable member for walking `FSharpEntity` to typed-tree walker](https://github.com/ionide/FSharp.Analyzers.SDK/pull/285)
- [Add overridable member for walking `FSharpMemberOrFunctionOrValue` to typed-tree walker](https://github.com/ionide/FSharp.Analyzers.SDK/pull/286)
